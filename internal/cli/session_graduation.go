...
func ignoredGraduationAction(command string) bool {
	switch command {
	case "open", "snapshot", "screenshot", "measure", "console", "requests", "highlight", "find", "tab-list", "request", "request-headers", "request-body", "response-headers", "response-body", "cookie-list", "cookie-get", "localstorage-list", "localstorage-get", "sessionstorage-list", "sessionstorage-get", "checkpoint", "wait":
		return true
	default:
		return false
	}
